...
*/
	...
	public void insert(OrderInfo orderInfo) throws AddException {
		insertInfo(orderInfo);
		insertLine(orderInfo);
	}
...
//		try {
	...
	@Transactional
	private void insertLine(OrderInfo orderInfo) throws AddException {
		try {
...
//			sqlSession.insert("com.my.vo.Order.insertOrderInfo", id);
			...
			throw new AddException("Line추가실패");
		}
	}
	
	@Transactional
	private void insertInfo(OrderInfo orderInfo) throws AddException {	
		try {
			String id = orderInfo.getCustomer().getId();
			sqlSession.insert("com.my.vo.Order.insertOrderInfo", id);
			...
			throw new AddException("Info추가실패");
		}
	}
//		else { //null인 경우
